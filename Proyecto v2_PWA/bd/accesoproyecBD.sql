...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2021 a las 17:39:43
...
(40, 'Andres Valerio', 'Martinez', 16, '2021-06-28 12:58:00', '1', 1),
...
--
ALTER TABLE `compania`
  MODIFY `id_com` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `visitantes`
  MODIFY `id_visi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
